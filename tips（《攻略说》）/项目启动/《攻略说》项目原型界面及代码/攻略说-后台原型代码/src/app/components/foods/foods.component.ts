...
export class FoodsComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.get('http://192.168.148.144:8080/food_lu').subscribe(data=>{
      this.foods_lu = data;
      this.databases[0]=this.foods_lu;
    });
    this.http.get('http://192.168.148.144:8080/food_chuan').subscribe(data=>{
      this.foods_chuan = data;
      this.databases[1] = this.foods_chuan;
    });
    this.http.get('http://192.168.148.144:8080/food_su').subscribe(data=>{
      this.foods_su = data;
      this.databases[2] = this.foods_su;
    });
    this.http.get('http://192.168.148.144:8080/food_yue').subscribe(data=>{
      this.foods_yue = data;
      this.databases[3] = this.foods_yue;
    });
    this.http.get('http://192.168.148.144:8080/sweet_binggan').subscribe(data=>{
      this.sweet_binggan = data;
      this.databases[4] = this.sweet_binggan;
    });
    this.http.get('http://192.168.148.144:8080/sweet_buding').subscribe(data=>{
      this.sweet_buding = data;
      this.databases[5] = this.sweet_buding;
    });
    this.http.get('http://192.168.148.144:8080/sweet_cake').subscribe(data=>{
  ...
  button1(num){
    ...
    if(num==0){
      // this.http.post('http://192.168.148.144:8080/'+'food_lu',this.input[num],{headers:this.headers}).subscribe(data => {});
    }
    if(num==1){
      // this.http.post('http://192.168.148.144:8080/'+'food_chuan',this.input[num],{headers:this.headers}).subscribe(data => {});
    }
    if(num==2){
      // this.http.post('http://192.168.148.144:8080/'+'food_su',this.input[num],{headers:this.headers}).subscribe(data => {});
    }
    if(num==3){
      // this.http.post('http://192.168.148.144:8080/'+'food_yue',this.input[num],{headers:this.headers}).subscribe(data => {});
    }
    if(num==4){
      // this.http.post('http://192.168.148.144:8080/'+'sweet_binggan',this.input[num],{headers:this.headers}).subscribe(data => {});
    }
    if(num==5){
      // this.http.post('http://192.168.148.144:8080/'+'sweet_buding',this.input[num],{headers:this.headers}).subscribe(data => {});
    }
    if(num==6){
      // this.http.post('http://192.168.148.144:8080/'+'sweet_dangao',this.input[num],{headers:this.headers}).subscribe(data => {});
    }
