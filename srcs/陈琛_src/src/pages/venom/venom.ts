...
export class VenomPage {
  ...
  shoucang(){
    ...
    if(this.loves.indexOf(this.movie.moviesName)>-1){
      alert('�����ղع���')
      	...
      	this.http.post('http://192.168.30.144:8080/'+'shoucang_movie',this.love,
  ...
  submit1(){
    ...
    if(Boolean(mypl.value)!=false){
      ...
      this.http.post('http://192.168.30.144:8080/'+'movie_comment',this.moviecomment,
            {headers:this.headers}).subscribe((data) => {});
    }
     else {
  ...
  constructor(public alertCtrl:AlertController,public navCtrl: NavController, public navParams: NavParams,public http:HttpClient) {
    ...
    this.http.get('http://192.168.30.144:8080/'+'movies1',{
      ...
      this.http.get('http://192.168.30.144:8080/'+'moviesRoles',{
        ...
        // ��������
     this.http.get('http://192.168.30.144:8080/'+'movie_comment',{
      headers:new HttpHeaders({})
    }).subscribe((data)=>{
